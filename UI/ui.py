...
RECOMMENDATION_BUTTON_COLOUR = (200, 200, 255)
RECOMMENDATION_BUTTON_HOVER_COLOUR = (100, 100, 155)
...
GENRE_TEXT_COLOUR = (0, 0, 0)
GENRE_BUTTON_COLOUR = (220, 220, 220)
GENRE_BUTTON_FILLED_COLOUR = (180, 180, 180)
GENRE_BUTTON_BORDER_COLOUR = (220, 220, 220)
GENRE_BUTTON_HOVER_COLOUR = (180, 180, 180)
...
def hide_drop_down(screen: pygame.Surface, episode_range_filter_display: EpisodeRangeFilterDisplay,
                   ...
                   genre_filter_display: GenreFilterDisplay, year_filter: AirDateFilterDisplay, back_button: Button) -> None:
    # Top section
...
def run_main(screen: pygame.Surface) -> None:
    ...
    while True:
        ...
        if genre_filter_display.menu_open_button.is_clicked(is_clicking, mouse_pos):
            if year_filter.input_box_start.is_active:
                year_filter.input_box_start.update_activity()
            if year_filter.input_box_end.is_active:
                year_filter.input_box_end.update_activity()
            ...
            if drop_down_menu.is_deployed:
                ...
                hide_drop_down(screen, episode_range_filter, recommendation_display, preference_display,
                               genre_filter_display, year_filter, account_button)
