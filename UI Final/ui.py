...
from graph import ReccomenderGraph, read_file
...
def get_user(username: str) -> User:
    g = read_file(['data/anime_formatted_no_duplicates.csv', 'data/profiles_formatted_no_duplicates.csv',
                   'data/reviews_formatted_no_duplicates.csv'])
...
def testing():
    animes = [
        ...
        Anime('Your lie in April Your lie in April Your lie in April Your lie in April Your lie in April',
              [randint(5, 10) for _ in range(6)]),
